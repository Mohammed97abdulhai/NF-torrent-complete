...
import com.example.asus.Core.messages.udp.UDPAnnounceRequestMessage;
import com.example.asus.Core.messages.udp.UDPConnectRequestMessage;
import com.example.asus.Core.messages.udp.UDPConnectResponseMessage;
import com.example.asus.Core.messages.udp.UDPTrackerMessage;
...
public class UDPTrackerClient extends TrackerClient {
	...
	public void announce(TrackerMessage.AnnounceRequestMessage.RequestEvent event,
		...
		int maxAttempts = TrackerMessage.AnnounceRequestMessage.RequestEvent
	...
	private void validateTrackerResponse(TrackerMessage message)
		...
		if (message instanceof TrackerMessage.ErrorMessage) {
			throw new AnnounceException(((TrackerMessage.ErrorMessage)message).getReason());
		}
