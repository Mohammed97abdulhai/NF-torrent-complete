package com.example.asus.Core.base;
...
public class Torrent implements Serializable{
    ...
    public Torrent(byte[] torrent, boolean seeder) throws IOException, NoSuchAlgorithmException {
        ...
        Log.i("nigger" , this.isMultifile() ? "Multi": "Single");
     ...
     * @author mpetazzoni
     */
    private static class CallableChunkHasher implements Callable<String> , Serializable {
     ...
     * length (see { #PIECE_LENGTH}) and returns the concatenation of
